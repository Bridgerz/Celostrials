...
interface GreysonNFTInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getUnmintedRandom()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getUnmintedRandom",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class GreysonNFT extends BaseContract {
  ...
  functions: {
    ...
    getUnmintedRandom(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    getUnmintedRandom(overrides?: CallOverrides): Promise<PopulatedTransaction>;
